...
class MyBot(irc.bot.SingleServerIRCBot):
    ...
    def search_community(self, connection, target, city):
        ...
        try:
            ...
            if communities:
                self.send_message(connection, target, f"Community in {BLUE}{city}{RESET}:")
                for community in communities:
                    ...
                    self.send_message(connection, target, f"Name: {BLUE}{community_name}{RESET} | Total Members/Subscribers: {BLUE}{total_members}{RESET} | Platform: {BLUE}{platform}{RESET} | URL: {BLUE}{url}{RESET} | Mods: {BLUE}{mods}{RESET}")
            else:
